...
class ItinerariesControllerTest < ActionController::TestCase
  ...
  test "should create itinerary" do
    assert_difference('Itinerary.count') do
      post :create, itinerary: { author: @itinerary.author, entry: @itinerary.entry, image_url: @itinerary.image_url, vote: @itinerary.vote }
    end
  ...
  test "should update itinerary" do
    patch :update, id: @itinerary, itinerary: { author: @itinerary.author, entry: @itinerary.entry, image_url: @itinerary.image_url, vote: @itinerary.vote }
    assert_redirected_to itinerary_path(assigns(:itinerary))
  end
